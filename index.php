...
<head>
    ...
    <title>Course & Book Store</title>
    <link rel="stylesheet" href="/assets/css/style.css">
</head>
<body>
    <header>
        <h1>Welcome to the Course and Book Store</h1>
        <nav>
        ...
        <div class="section">
            ...
            <ul>
                <?php while ($course = $courses_result->fetch_assoc()): ?>
                    <li>
                        <h3><a href="/php/course_detail.php?id=<?php echo $course['id']; ?>"><?php echo htmlspecialchars($course['title']); ?></a></h3>
        ...
        <div class="section">
            ...
            <ul>
                <?php while ($book = $books_result->fetch_assoc()): ?>
                    <li>
                        <h3><a href="/php/book_detail.php?id=<?php echo $book['id']; ?>"><?php echo htmlspecialchars($book['title']); ?></a></h3>
